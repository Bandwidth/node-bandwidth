...
describe("searchAndOrderNumberQueries", function () {
	...
	describe("NpaNxxSearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.NpaNxxSearchAndOrderNumbersQuery({npaNxx: "num", enableTnDetail: true, enableLca: true})).toXml().should.containDeep({
	...
	describe("TollFreeVanitySearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.TollFreeVanitySearchAndOrderNumbersQuery({tollFreeVanity: "value"})).toXml().should.containDeep({
	...
	describe("TollFreeWildCharSearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.TollFreeWildCharSearchAndOrderNumbersQuery({tollFreeWildCardPattern: "value"})).toXml().should.containDeep({
	...
	describe("CitySearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.CitySearchAndOrderNumbersQuery({state: "NC", city: "Cary"})).toXml().should.containDeep({
	...
	describe("LataSearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.LataSearchAndOrderNumbersQuery({lata: "lata"})).toXml().should.containDeep({
	...
	describe("CombinedSearchAndOrderNumbersQuery", function () {
		it("should build right XML", function () {
			(new client.CombinedSearchAndOrderNumbersQuery({lata: "lata"})).toXml().should.containDeep({
