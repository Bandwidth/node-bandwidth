...
var Account = function (client) {
	 ...
	 * @param {String} [toDate] Return only transactions that are newer than the parameter.
	 * @param {String} [fromDate] Return only transactions that are older than the parameter.
	 * @param {String} [type] Return only transactions that are this type.
	 * @param {Function} callback A callback with the list of transactions
	 * @return {Array.<TransactionResponse>} A promise for the list of transactions
	 */
