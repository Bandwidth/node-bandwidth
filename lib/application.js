var getNextLink = require("./util").getNextLink;
...
var Application = function (client) {
	 ...
	 * @return {Application} A promise for the list of applications, has a getNextPage
	 ...
	 * @return {Application} A promise for the application.
	 */
