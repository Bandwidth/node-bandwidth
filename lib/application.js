...
var Application = function (client) {
	 ...
	 *
	 * @example
	 * //Iterate over array of 1000
	 *
	 * client.Application.list({size: 1000})
	 * .then(function (results) {
	 * 	results.applications.forEach(function(app){
	 * 		console.log(app.incomingCallUrl);
	 * 		console.log(app.incomingMessageUrl);
	 * 	});
	 * });
	 */
