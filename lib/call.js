 ...
 * @param snetence sentence to speak
 * @param tag tag value which will be used in events
 * @param callback callback function
 * @example
 ...
 * @param callback callback function
 * @example
 * call.createGathe("Press a digit", function(err, gather){})
 * call.createGathe({maxDigits: 1, prompt: {sentence: "Press a digit", bargeable: true }}, function(err, gather){})
 * */
