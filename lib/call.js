...
var Call = function (client) {
	 ...
	 * @param {String} params.interDigitTimeout Stop gathering if a DTMF digit is not detected
	 ...
	 * @param {Boolean} params.prompt.loopEnabled When value is true, the audio will keep playing in a loop
	 * @param {Boolean} params.prompt.bargeable Make the prompt (audio or sentence) bargeable
