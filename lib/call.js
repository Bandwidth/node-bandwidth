...
var Call = function (client) {
	 ...
	 */
	this.list = function (callId, params, callback) {
		return client.makeRequest({
			path   : "calls/" + callId,
			method : "GET",
			qs     : params
	...
	this.answerCall = function (callId, callback) {
		return this.update(callId, { state : "active" }).nodeify(callback);
	};
	...
	this.speakSentence = function (callId, sentence, callback) {
		return audioApi(callId, { sentence : sentence }).nodeify(callback);
	};

	this.playAudio = function (callId, fileUrl, callback) {
		return audioApi(callId, { fileUrl : fileUrl }).nodeify(callback);
	};

	this.enableRecording = function (callId, callback) {
		return this.update(callId, { recordingEnabled : true }).nodeify(callback);
	};

	this.setRecordingMaxDuration = function (callId, recordingMaxDuration, callback) {
		return this.update(callId, { recordingMaxDuration : recordingMaxDuration }).nodeify(callback);
	};
};
