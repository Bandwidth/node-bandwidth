...
var Conference = function (client) {
	 ...
	 * @param {String} [params.state] Conference state. Possible state values are: "completed" to terminate the conference.
	 ...
	 * {@link http://ap.bandwidth.com/docs/rest-api/conferences/#resourcePOSTv1usersuserIdconferencesconferenceIdaudio|docs}
	 ...
	 *
	 * //Promise
	 * client.Conference.speakSentenceToMember("conferenceID", "memberID", Hello From Bandwidth").then(function (res) {});
	 *
	 * //Callback
	 * client.Conference.speakSentenceToMember("conferenceID", "memberID", "Hello From Bandwidth", function (err, res) {});
	 */
	 ...
	 *
	 * //Promise
	 * client.Conference.playAudioFileToMember("conferenceID", "memberId", http://myurl.com/file.mp3").then(function (res) {});
	 *
	 * //Callback
	 * client.Conference.playAudioFileToMember("conferenceID", "memberId", http://myurl.com/file.wav", function (err, res) {});
	 */
	 ...
	 * }
	 * //Promise
	 * client.Conference.playAudioAdvancedToMember("conferenceId", "memberId", options).then(function (res) {});
	 *
	 * //Callback
	 * client.Conference.playAudioAdvancedToMember("conferenceId", "memberId", options, function (err,res) {});
	 * @example
	 * //Speak sentence with options
	 * var options = {
	 * 	sentence : "hola de Bandwidth",
