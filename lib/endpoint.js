...
var Endpoint = function (client) {
	 ...
	 * @param {domainId} [params.domainId]
	 * @param {Number} [params.size] The maximum number of endpoints returned by
	 ...
	 */
	this.list = function (domainId, size, callback) 		return client.makeRequest({{
