...
var Domain = function (client) {
	 ...
	 *   name        : "unicornApp",
	 *   description : "Unicorn Inc.'s new, disruptive app."
	 * });
	 */
	 ...
	 * client.Domain.list()
	 * .then(function(response){
	 *   console.log(response); //Will contain all of your domains.
	 * }); 
	 */
	 ...
	 * @return {Promise} A promise for current operation. Resolves to undefined.
	 * @example
	 * client.Domain.delete("someDomainId")
	 * .then(function(response){
