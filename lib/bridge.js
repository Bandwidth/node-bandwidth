...
var Bridge = function (client) {
	 ...
	 * @param {String} [params.gender] The gender of the voice used to synthesize the sentence.
	 * It will be considered only if sentence is not null. The female gender will be used by default.
	 * @param {String} [params.locale] The locale used to get the accent of the voice used to synthesize the sentence.
	 * Currently audio supports:
	 *
	 ...
	 * @param {String} [params.voice] The voice to speak the sentence. Audio currently supports the following voices:
	 *
	 ...
	 * @param {Boolean} [params.loopEnabled] When value is true, the audio will keep playing in a loop. Default: false.
	 * @param {Function} [callback] Callback for the operation
	 * @return {Promise} A promise for the operation
	 * @example
